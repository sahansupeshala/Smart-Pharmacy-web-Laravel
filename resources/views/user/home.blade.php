...
<body>
    ...
    <header class="sticky-top">
        <nav class="navbar navbar-expand navbar-light " style="background-color: #000300;">
            <div class="container-fluid font-weight-bold">
                <a href="#" class="navbar-brand d-lg-block ml-5">
                    <img src="../image/logo1.png"
                        alt="" width="40" height="30" loading="lazy" class="d-inine-block align-top">
                        <span class="text-success">Smart</span><span class="text-primary">Pharmacy</span>
                </a>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-2 bg-light border-right " style="height: 100vh">
                ...
                <div class="row border-bottom mb-2 mt-4 bg-white">
                    <div class="col-12">
                        <img src="../image/logo2.avif"
                            width="160px" height="60px" alt="" class="rounded mx-auto d-block img-fluid">

                        <div class="text-center mt-2 mb-3">
                            <span class="h5 font-weight-bold"><span class="text-success">Customer</span>
            ...
            <div class="col-10">
                ...
                <div class="col-12 mt-3 text-center font-style-italic shadow-sm p-3 bg-body rounded">
                    <span class="text-muted">Developed By T.W.Supeshala Sumanasena For Xiteb Practical Test @ 2023</a></span>
                </div>
            </div>
            <!-- End Right -->
        </div>
