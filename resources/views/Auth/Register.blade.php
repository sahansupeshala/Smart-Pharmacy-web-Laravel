                    ...
                    <div class="card-body">
                        <form action="{{ url('store') }}" method="POST">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            placeholder="Ex: Supeshala Sumanasena" name="name" value="{{ old('name') }}">
                                        @error('name')
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Ex: 0716784564" name="mobile"
                                            value="{{ old('mobile') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('address') is-invalid @enderror" id="Address" placeholder="Ex: 145/A , New Town , Ratnapura" rows="3" name="address"></textarea>
                                @error('address')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
